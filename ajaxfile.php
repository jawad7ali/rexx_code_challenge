...
if($searchValue != ''){
	$searchQuery .= " and (customer_name like '%".$searchValue."%' or 
        ...
        product_price like'%".$searchValue."%' ) ";
}

## Total number of records without filtering
$sel = mysqli_query($con,"select count(*) as allcount from sales");
$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['allcount'];

## Total number of records with filtering
$sel = mysqli_query($con,"select count(*) as allcount from sales WHERE 1 ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
